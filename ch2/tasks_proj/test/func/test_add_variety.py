...
def test__add_3(summary, owner, done):
...
class TestAdd():
    ...
    def test__equivalent(self, task):
...
def equivalent(t1, t2):
    ...
    # Compare everything but he id field
...
def initalized_tasks_db(tmpdir):
